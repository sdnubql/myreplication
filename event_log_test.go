...
func TestWriteRowsEventV1(t *testing.T) {
	...
	testCases := []*rowEventTestCase{
		&rowEventTestCase{
			tableMapEventBuff: []byte{
				0x40, 0x00, 0x00, 0x05, // packet head
				0x00,                   // ok
				0x13, 0x0a, 0x1d, 0x55, // timestamp
				0x13,                   // event type [TABLE_MAP_EVENT]
				0x01, 0x00, 0x00, 0x00, // server id
				0x3f, 0x00, 0x00, 0x00, // event size
				0x72, 0x01, 0x00, 0x00, // log pos
				0x00, 0x00, // flags
				0x26, 0x00, 0x00, 0x00, 0x00, 0x00, // table id
				0x01, 0x00, // flags
				0x08, 0x64, 0x65, 0x76, 0x69, 0x63, 0x65, 0x64, 0x62, 0x00, // len[8] str[devicedb] [00]
				// len[e] str[app_device_ext] [00]
				0x0e, 0x61, 0x70, 0x70, 0x5f, 0x64, 0x65, 0x76, 0x69, 0x63, 0x65, 0x5f, 0x65, 0x78, 0x74, 0x00,
				0x05, 0x08, 0x03, 0x0f, 0x0c, 0x07, // 5 column-def
				0x02, 0x00, 0x0c, // column-meta-def
				0x06, // nul-map
			},
			rowsEventBuff: []byte{
				,
			},
			expectedValues: [][]*RowsEventValue{
				[]*RowsEventValue{
